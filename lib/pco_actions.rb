...
class PcoActions
  ACTIONS = [
    ...
    { name: "All the Sidekiqs", desc: "Ultimate Sidekiq-ery! Requires active VPN connection.", value: "https://all-the-sidekiqs.planningcenteronline.com/", icon: "img/sidekiq.png" },
    { name: "Sidekiq", desc: "Every hero needs a trusty sidekiq. Choose your app + env.", value: "sidekiq", icon: "img/sidekiq.png" },
